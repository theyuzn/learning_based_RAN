...
legend('FCFS,$N_{UE} = 100$','FCFS,$N_{UE} = 200$','FCFS,$N_{UE} = 300$', ...
        'DRL-LS,$N_{UE} = 100$', 'DRL-LS,$N_{UE} = 200$', 'DRL-LS,$N_{UE} = 300$', ...
        'Location', 'northwest', 'interpreter','latex','fontsize', 24, 'NumColumns', 2 );
