...
y = xlsread('/Users/dee/Research/li_sche_pytorch/src/data/result/result_data.xlsx','tp','b3:h5');
...
legend('RAS FCFS','RAS DRL-LS','Traditional PF', 'Location', 'northwest', 'interpreter','latex','fontsize', 24, 'NumColumns', 1 );
